...
mf_info=$(
    printf \
        '[{"dns":"%s","device_port":"443","owner_port":"443","protocol":"https","delay_seconds":10},{"dns":"%s","device_port":"80","owner_port":"80","protocol":"http","delay_seconds":10}]' \
        $BOARD_RV_DOMAIN $BOARD_RV_DOMAIN
)
...
send_req "$BOARD_MAN/api/v1/rvinfo" "$mf_info" | jq
